 ...
 * @since 1.0.0
 */
export var fold = function (as, b, cons) {
 ...
 * @since 1.0.0
 */
export var foldL = function (as, nil, cons) {
 ...
 * @param cons
 */
export var foldr = function (as, b, cons) {
 ...
 * @param cons
 */
export var foldrL = function (as, nil, cons) {
 ...
 * @since 1.0.0
 */
export var findIndex = function (as, predicate) {
    var len = as.length;
    for (var i = 0; i < len; i++) {
        if (predicate(as[i])) {
            return some(i);
 ...
 * @since 1.16.0
 */
export var findFirstMap = function (arr, f) {
    var len = arr.length;
    for (var i = 0; i < len; i++) {
        var v = f(arr[i]);
        if (v.isSome()) {
 ...
 * @since 1.16.0
 */
export var findLastMap = function (arr, f) {
    var len = arr.length;
    for (var i = len - 1; i >= 0; i--) {
        var v = f(arr[i]);
        if (v.isSome()) {
 ...
 * @since 1.10.0
 */
export var findLastIndex = function (as, predicate) {
    var len = as.length;
    for (var i = len - 1; i >= 0; i--) {
        if (predicate(as[i])) {
            return some(i);
 ...
 * @since 1.0.0
 */
export var insertAt = function (i, a, as) {
 ...
 * @since 1.0.0
 */
export var updateAt = function (i, a, as) {
 ...
 * @since 1.0.0
 */
export var deleteAt = function (i, as) {
 ...
 * @since 1.0.0
 */
export var modifyAt = function (as, i, f) {
 ...
 * @since 1.0.0
 */
export var rotate = function (n, xs) {
    var len = xs.length;
 ...
 * @since 1.14.0
 */
export var elem = function (S) { return function (a, as) {
 ...
 * @since 1.10.0
 */
export var chunksOf = function (as, n) {
 ...
 * @since 1.12.0
 */
export var intersection = function (S) {
    var elemS = elem(S);
 ...
 * @since 1.12.0
 */
export var difference = function (S) {
    var elemS = elem(S);
    return function (xs, ys) { return xs.filter(function (a) { return !elemS(a, ys); }); };
};
