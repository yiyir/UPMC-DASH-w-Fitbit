 ...
 * @since 1.14.0
 */
export var elem = function (S) { return function (a, m) {
    var values = m.values();
    var e;
 ...
 * @since 1.14.0
 */
export var insert = function (S) {
    var lookupS = lookupWithKey(S);
 ...
 * @since 1.14.0
 */
export var pop = function (S) {
    var lookupS = lookup(S);
    var removeS = remove(S);
    return function (k, m) { return lookupS(k, m).map(function (a) { return [a, removeS(k, m)]; }); };
};
/**
 ...
 * @since 1.14.0
 */
export var lookupWithKey = function (S) { return function (k, m) {
 ...
 * @since 1.14.0
 */
export var lookup = function (S) {
    var lookupWithKeyS = lookupWithKey(S);
 ...
 * @since 1.14.0
 */
export var isSubmap = function (SK, SA) {
 ...
 * @since 1.14.0
 */
export var getSetoid = function (SK, SA) {
 ...
 * @since 1.14.0
 */
export var getMonoid = function (SK, SA) {
    var lookupWithKeyS = lookupWithKey(SK);
    return {
...
var getFunctorWithIndex = function () {
    return __assign({ _L: phantom }, functor, { mapWithIndex: mapWithIndex });
};
/**
 * @since 1.14.0
 */
...
var getTraversable = function (O) {
    return __assign({ _L: phantom }, getFoldable(O), functor, { traverse: traverse,
        sequence: sequence });
};
/**
 * @since 1.14.0
