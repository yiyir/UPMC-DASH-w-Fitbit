...
var FBOS3_EVAL_QUIRK = /^[a-zA-Z]+ \d+\.33\.1\.[1-3]?\d$/;
var RemoteHost = (function (_super) {
    ...
    RemoteHost.connect = function (hostStream, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.userAgentSuffix, userAgentSuffix = _c === void 0 ? '' : _c, _d = _b.timeout, timeout = _d === void 0 ? 10000 : _d, _e = _b.postDeserializeTransform, postDeserializeTransform = _e === void 0 ? new stream.PassThrough({ objectMode: true }) : _e, _f = _b.preSerializeTransform, preSerializeTransform = _f === void 0 ? new stream.PassThrough({ objectMode: true }) : _f;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var userAgent, host, reqTime, _g;
