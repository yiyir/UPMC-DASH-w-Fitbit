...
function makeDeviceManifest({ projectConfig, buildId, }) {
    ...
    return new stream_1.Transform({
        ...
        flush(done) {
            const _a = projectConfig.defaultLanguage, defaultLanguage = locales[_a], otherLocales = tslib_1.__rest(locales, [typeof _a === "symbol" ? _a : _a + ""]);
            if (!entryPoint) {
                return done(new plugin_error_1.default(PLUGIN_NAME, 'No entry point was generated for device component'));
            }
            const manifest = Object.assign({ appManifestVersion: 1, main: entryPoint, svgMain: resources.svgMain, svgWidgets: resources.svgWidgets, appType: projectConfig.appType }, makeCommonManifest({
                projectConfig,
                buildId,
                apiVersion: sdkVersion_1.apiVersions(projectConfig).deviceApi,
            }), { i18n: lodash_1.default.mapKeys(Object.assign({ [projectConfig.defaultLanguage]: defaultLanguage }, otherLocales), (_, locale) => locale.toLowerCase()) }, (projectConfig.appType !== ProjectConfiguration_1.AppType.CLOCKFACE && {
