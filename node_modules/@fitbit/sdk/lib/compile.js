...
function compile({ component, entryPoint, outputDir, defaultLanguage, allowUnknownExternals = false, onDiagnostic = diagnostics_1.logDiagnosticToConsole, polyfills = {}, }) {
    ...
    return rollupToVinyl_1.default({
        ...
        plugins: [
            ...
            ...pluginIf((sdkVersion_1.default().major >= 4 ||
                (sdkVersion_1.default().major === 3 && sdkVersion_1.default().minor >= 1)) &&
                component === componentTargets_1.ComponentType.DEVICE, polyfillDevice_1.default),
            ...pluginIf((sdkVersion_1.default().major >= 4 ||
                (sdkVersion_1.default().major === 3 && sdkVersion_1.default().minor >= 1)) &&
                component !== componentTargets_1.ComponentType.DEVICE, () => polyfill_1.default(i18nPolyfill_1.default(translationsGlob, defaultLanguage))),
