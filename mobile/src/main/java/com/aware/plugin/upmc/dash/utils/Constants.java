...
public final class Constants {
    ...
    public static final String ACTION_CHECK_CONN = "check watch connection";
    ...
    public static final String CONN_STATUS = "Tap to check watch connection";
...
//    public static final String NOTIFTEXT_TRY_CONNECT = "Scanning for watch...";
    ...
    public static final String TABLE_MINI = "Minimessage";
